    ...
    <main className="about-main">
      ...
      <div className="about-container">
        ...
        <p className="about-description">
          At <span className="highlight">FlexiPay</span>, we believe in making mobile recharges fast, easy, and secure. Our platform provides users with a seamless experience to recharge on the go. We are committed to delivering a reliable and user-friendly service that keeps you connected at all times.
        </p>
